...
This repository is the frontend-only portfolio edition. It uses cached demonstration datasets so the experience is dependable, fast, and safe to explore without API credentials or model charges.
